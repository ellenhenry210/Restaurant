...
- Remaining resource routes the permission matrix (Part 1) covers — menu/inventory writes, payment, analytics. `view_menu` (read) and the full order lifecycle (guest + staff/kitchen) are wired up; nothing writes to the menu/inventory side yet.
